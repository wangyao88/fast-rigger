 ...
 * sql执行器
 * @author wy
 * @date 2019-06-11 13:34:11
 */
public class SqlRunner {

    private static final int NO_GENERATED_KEY = Integer.MIN_VALUE + 1001;
    ...
    public int insert(String sql, Object... args) throws SQLException {
        @Cleanup
        PreparedStatement ps = getPreparedStatement(sql, useGeneratedKeySupport);
        setParameters(ps, args);
        ps.executeUpdate();
    ...
    private PreparedStatement getPreparedStatement(String sql, boolean useGeneratedKeySupport) throws SQLException {
        if (useGeneratedKeySupport) {

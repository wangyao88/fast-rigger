...
public class StringUtils {
     ...
     * @Description : 调用lang3的split方法，按照分隔符循环分隔字符串
     */
    public static String[] splitStringToStringArr(String str, String separatorChars){
    ...
    public static String append(String separator, String... strs){
    	...
    	for(String str : strs){
    		str = StringUtils.isEmpty(str) ? StringUtils.EMPTY : str;
    		results.add(str);
    	}
    	return Joiner.on(separator).join(results);
    }

    public static String appendJoinEmpty(String... strs){
    	return append(StringUtils.EMPTY,strs);
    }
	...
	public static String toStringForExcle(Object str) {
	    return (str == null) ? "" : ("NULL".equals(str.toString().toUpperCase())?"":str.toString().trim());
	}
    ...
    public static String valueOf(Object value) {
        return StringUtils.EMPTY + value;
    }
}